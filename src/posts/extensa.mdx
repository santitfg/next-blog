...
## Extensa un proyecto de investigacion que busca acercar el cuerpo a la interaccion con las computadoras por medio de generar una interfaz gestual extendiendo leguajes de Live Coding (programacion en vivo)  
